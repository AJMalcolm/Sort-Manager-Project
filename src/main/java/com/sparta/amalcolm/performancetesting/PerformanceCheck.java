...
import com.sparta.amalcolm.util.UserPerfCheckInput;
...
public class PerformanceCheck {
    ...
    public static final Logger logger = LogManager.getLogger(PerformanceCheck.class);

    public static void PerformanceTest(){

        averageRepetitions = UserPerfCheckInput.UserPerfTestInput();
